        ...
        <ScrollView contentContainerStyle={styles.scrollContent}>
          ...
          <View style={styles.section}>
            ...
            <View style={styles.vehiclesContainer}>
              <TouchableOpacity 
                style={[styles.vehicleButton, selectedVehicle === 'bus' && styles.selectedVehicle, styles.busButton]}
              ...
              <TouchableOpacity 
                style={[styles.vehicleButton, selectedVehicle === 'van' && styles.selectedVehicle, styles.vanButton]}
              ...
              <TouchableOpacity 
                style={[styles.vehicleButton, selectedVehicle === 'jeep' && styles.selectedVehicle, styles.jeepButton]}
